...
const props = defineProps<{
  topics: Topic[];
  onChoose2: (typeChosen: string) => void;
  onChoose3: (typeChosen: string) => void;
}>();
...
<template>
  <div class="home-link items-center">
    <div
      class="w-full px-[20px] flex items-center gap-[24px] border-b border-solid border-[#d1d1d1]"
    >
      <div class="h-[56px] flex items-center gap-[24px] text-sm text-[#767676]">
        <span
          class="hover:text-black hover:cursor-pointer h-[56px] flex items-center"
      ...
      <div class="h-[32px] w-[1px] bg-[#d1d1d1]"></div>
      <div
        class="h-[56px] flex items-center text-sm text-[#767676] overflow-hidden"
      >
        <button
          @click="scrollLeft"
          class="h-full z-10 bg-white bg-opacity-80 hover:bg-opacity-100 px-2"
        >
          <img
            src="/src/assets/arrow-left-01-stroke-rounded.svg"
            alt="arrow-left"
        ...
        >
          <img
            src="/src/assets/arrow-right-01-stroke-rounded.svg"
            alt="arrow-right"
            class="hover:brightness-0 hover:contrast-100"
          />
        </button>
