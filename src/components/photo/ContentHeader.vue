...
<template>
  <div class="py-[56px]">
    <div
      class="flex max-w-[1336px] gap-[24px] px-[20px] box-border mx-auto items-end"
    >
      ...
      <div
        v-else-if="props.topic !== null"
        class="w-2/4 flex flex-col gap-[24px]"
      >
      ...
      <div
        ...
        class="w-1/4 border border-solid border-[#d1d1d1] rounded-lg"
      >
        <div class="p-[20px]">
          ...
          <a
            href="#"
            class="text-sm text-[#767676] mt-4 inline-block hover:text-black"
            >See all</a
          >
        </div>
      </div>
      ...
      <div class="w-1/4 flex-grow relative overflow-hidden rounded-md">
        <img
          src="https://images.unsplash.com/photo-1726629597612-a48c0fdd0fe6?fm=jpg&q=60&w=3000&ixid=M3wxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNzMwNjAyODgyfA&ixlib=rb-4.0.3"
          alt="Featured"
